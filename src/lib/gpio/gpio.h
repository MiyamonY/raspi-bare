...
#define GPIO_MODE_BIT_LEN 3

typedef enum { GPIO_PULL_OFF = 0b00, GPIO_PULL_DOWN = 0b01, GPIO_PULL_UP = 0b10 } gpio_pull_upd_t;

typedef enum {
  GPIO_MODE_INPUT = 0b000,
  GPIO_MODE_OUTPUT = 0b001,
  GPIO_MODE_ALT0 = 0b100,
  GPIO_MODE_ALT0_PULL_DOWN = GPIO_MODE_ALT0 | (GPIO_PULL_DOWN << GPIO_MODE_BIT_LEN),
